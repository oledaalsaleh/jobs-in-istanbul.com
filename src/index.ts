...
export default {
  async fetch(request: Request, env: any, ctx: any) {
    ...
    if (url.pathname === '/salary-calculator-2026' || url.pathname === '/investor-calculator' || url.pathname === '/work-permit-eligibility' || url.pathname === '/cv-optimizer' || url.pathname === '/workplace-quiz' || url.pathname === '/resume-builder') {
